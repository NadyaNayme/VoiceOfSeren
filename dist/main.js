        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    clanVote = [];
                    if (debugMode)
                        console.log('Skipping scan. Reason: Outside of Prifddinas (likely)');
...
function initSettings() {
    ...
    getByID('debugMode').addEventListener('click', function (e) {
        var el = getByID('debugMode');
...
var settingsObject = {
    ...
    uiScale: _a1sauce__WEBPACK_IMPORTED_MODULE_1__.createRangeSetting('uiScale', 'Resize VoS app', {
        defaultValue: (_c = _a1sauce__WEBPACK_IMPORTED_MODULE_1__.getSetting('uiScale')) !== null && _c !== void 0 ? _c : '100',
        min: 30,
        max: 200,
        unit: '%',
    }),
