...
helperItems.Get.addEventListener('click', function (e) {
    fetchVos();
    updateSetting('lastFetch', luxon__WEBPACK_IMPORTED_MODULE_0__.DateTime.Now());
});
helperItems.Vote.addEventListener('click', function (e) {
    var lastVoteTime = getSetting('lastVote');
    if (lastVoteTime == undefined) {
        updateSetting('lastVote', luxon__WEBPACK_IMPORTED_MODULE_0__.DateTime.Now());
    }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    alt1.overLayRect(alt1__WEBPACK_IMPORTED_MODULE_5__.mixColor(255, 255, 255), Math.floor(alt1__WEBPACK_IMPORTED_MODULE_5__.getMousePosition().x), Math.floor(alt1__WEBPACK_IMPORTED_MODULE_5__.getMousePosition().y), 300, 50, 200, 2);
